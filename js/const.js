...
export const EDITICON = `<svg class="task__button-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const PLUSICON = `<svg class="header__button-icon"
